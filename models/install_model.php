...
*/		
	...
	{
		$sth = $this->db->prepare('SELECT * FROM nova_users
			WHERE id = "1"');
...
'Hem', 'yes', 'Gästbok', 'yes', 'Blogg', 'yes', 'Artiklar', 'yes', 'Kontakt', 'yes', 
'Info', 'yes', 'Skriv', 'yes', 'Skräp', 'yes', 'yes', 'Admin', 'Profil', 'Login', 'Logout'),
(2, 'default', 'yes', 'Nova', 'yes', 
'http://www.student.bth.se/~anza13/phpmvc/me/kmom08-10/mvc_nova/themes/images/logo.png', 
'horisontal', 'yes', '&copy; Anactazia', 'default', 
'http://www.student.bth.se/~anza13/phpmvc/me/kmom08-10/mvc_nova/', 'anactazia@hotmail.com', 
'Hem', 'yes', 'Gästbok', 'yes', 'Blogg', 'yes', 'Artiklar', 'yes', 'Kontakt', 'yes', 'Info', 
'yes', 'Skriv', 'yes', 'Skräp', 'yes', 'yes', 'Admin', 'Profil', 'Login', 'Logout')";
